...
\newglossaryentry{puissance}{name={puissance}, description={1-$\beta$, $\beta$ étant la probabilité de rejeter l'hypothèse nulle quand elle est fausse càd conclure à l'absence de différence alors
qu'elle existe.}}
...
\newglossaryentry{quartiles}{name={quartiles}, description={Valeurs qui séparent une série statistique quantitative aux seuils de 25 \% et de 75 \% (la médiane sépare au seuil de 50 \%).}}
