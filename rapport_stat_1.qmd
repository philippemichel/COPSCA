...
Vu le faible nombre de cas dans chaque tranche de copeptine les intervalles de confiance (non représentés) sont énormes. Il semble néanmoins que le dosage de la copeptine serait plus intéressant quand la troponine est basse.  
...
Sur notre échantillon le seuil optimal pour la copeptine serait de 11,8 pg/mL. On refait donc les calculs avec ce seuil.
