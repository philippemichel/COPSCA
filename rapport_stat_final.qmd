---
subtitle: "Rapport statistique V2.1"
cache: false
---
...
tt |>
  drop_na(scanonston) |>
dplyr::select(htaon:tabacpa,scanonston) |>
tbl_summary(missing = "no", 
            by = scanonston,
             statistic = stt,
            value = ouinon) |>
...
tt |>
  dplyr::select(sympt_urg:urg_h3,adm_h0, h0h3, scanonston) |>
  tbl_summary(
    missing = "no",
    by = scanonston,
    statistic = stt
...
- Pour la trononine : supérieur à 15,6 pg/mL pour les femmes & supérieur à 34,2 pg/mL pour les hommes
- Pour la copeptine : supérieur à 10 pg/mL pour les deux sexes
